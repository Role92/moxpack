...
# for the first time.
d-i pkgsel/include string haveged openssh-server sudo qemu-guest-agent python3 acpid acpi-support dbus ca-certificates curl wget vim cloud-init cloud-initramfs-growroot
